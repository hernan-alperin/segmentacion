...
def costo_segmento(segmento): 
    ...
    if carga > cantidad_de_viviendas_maxima_deseada_por_segmento:
        ...
        return ((carga - cantidad_de_viviendas_maxima_deseada_por_segmento)**4 
...
def costo_segmentacion(segmentacion): 
    ...
    return sum(costos_segmentos(segmentacion)) + 1e3*cantidad_de_segmentos
